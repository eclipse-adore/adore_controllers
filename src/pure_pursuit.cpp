...
{
void
PurePursuit::set_parameters( const std::map<std::string, double>& params )
{
...
PurePursuit::get_next_vehicle_command( const dynamics::Trajectory& trajectory, const dynamics::VehicleStateDynamic& current_state )
{
...
double
PurePursuit::compute_steering_angle( const dynamics::VehicleStateDynamic& current_state,
                                     const dynamics::VehicleStateDynamic& reference_state )
{
...
double
PurePursuit::compute_acceleration( const dynamics::VehicleStateDynamic& current_state,
                                   const dynamics::VehicleStateDynamic& reference_state )
{
...
PurePursuit::PurePursuit() {} // Initialization
} // namespace controllers
} // namespace adore
